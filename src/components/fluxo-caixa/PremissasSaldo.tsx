  ...
  return (
    <div className="space-y-3">
      ...
      <p className="text-xs text-[var(--text-muted)]">
        Valores em reais. Apague o conteúdo de uma célula para remover o valor daquele mês. O saldo real de um mês passa a ser o saldo inicial do mês seguinte no Fluxo próprio.
      </p>
    </div>
  );
}
